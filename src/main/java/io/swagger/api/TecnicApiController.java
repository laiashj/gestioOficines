...
public class TecnicApiController {
    ...
    public Tecnic getTecnicById(@PathVariable String id) {
    ...
    @RequestMapping(method = RequestMethod.GET, value = "/tecnics/{nom}")
    public Tecnic getTecnicByNom(@PathVariable String nom) {
	ArrayList<Tecnic> llista=new ArrayList<>();
